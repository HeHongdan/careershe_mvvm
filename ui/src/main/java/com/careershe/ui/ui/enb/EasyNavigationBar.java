package com.careershe.ui.ui.enb;
...
public class EasyNavigationBar extends LinearLayout {
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        contentView = (RelativeLayout) View.inflate(context, com.next.easynavigation.R.layout.container_layout, null);
        addViewLayout = contentView.findViewById(com.next.easynavigation.R.id.add_view_ll);
        AddContainerLayout = contentView.findViewById(com.next.easynavigation.R.id.add_rl);
        empty_line = contentView.findViewById(com.next.easynavigation.R.id.empty_line);
        navigationLayout = contentView.findViewById(com.next.easynavigation.R.id.navigation_ll);
        lineView = contentView.findViewById(com.next.easynavigation.R.id.common_horizontal_line);
        lineView.setTag(-100);
        empty_line.setTag(-100);
        navigationLayout.setTag(-100);


        TypedArray attributes = context.obtainStyledAttributes(attrs, com.next.easynavigation.R.styleable.EasyNavigationBar);
    ...
    private void parseStyle(TypedArray attributes) {
        if (attributes != null) {
            //要放在前面
            textSizeType = attributes.getInt(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_textSizeType, textSizeType);


            msgPointColor = attributes.getColor(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_msgPointColor, msgPointColor);
            navigationHeight = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_navigationHeight, navigationHeight);
            navigationBackground = attributes.getColor(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_navigationBackground, navigationBackground);

            msgPointMoreWidth = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_msgPointMoreWidth, msgPointMoreWidth);
            msgPointMoreHeight = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_msgPointMoreHeight, msgPointMoreHeight);
            msgPointMoreRadius = attributes.getInt(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_msgPointMoreRadius, msgPointMoreRadius);
            tabTextSize = NavigationUtil.compareTo(getContext(), attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_tabTextSize, 0), tabTextSize, textSizeType);
            tabTextTop = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_tabTextTop, tabTextTop);
            iconSize = (int) attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_tabIconSize, iconSize);
            hintPointSize = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_hintPointSize, hintPointSize);
            msgPointSize = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_msgPointSize, msgPointSize);
            hintPointLeft = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_hintPointLeft, hintPointLeft);
            msgPointTop = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_msgPointTop, -iconSize * 3 / 5);
            hintPointTop = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_hintPointTop, hintPointTop);

            msgPointLeft = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_msgPointLeft, -iconSize / 2);
            msgPointTextSize = NavigationUtil.compareTo(getContext(),attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_msgPointTextSize, 0),msgPointTextSize,textSizeType);
            centerIconSize = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_centerIconSize, centerIconSize);
            centerLayoutBottomMargin = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_centerLayoutBottomMargin, centerLayoutBottomMargin);

            //加号属性
            centerSelectTextColor = attributes.getColor(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_centerSelectTextColor, centerSelectTextColor);
            centerNormalTextColor = attributes.getColor(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_centerNormalTextColor, centerNormalTextColor);
            centerTextSize = NavigationUtil.compareTo(getContext(), attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_centerTextSize, 0), centerTextSize, textSizeType);
            centerTextTopMargin = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_centerTextTopMargin, centerTextTopMargin);
            centerAlignBottom = attributes.getBoolean(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_centerAlignBottom, centerAlignBottom);


            lineHeight = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_lineHeight, lineHeight);
            lineColor = attributes.getColor(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_lineColor, lineColor);


            centerLayoutHeight = attributes.getDimension(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_centerLayoutHeight, navigationHeight + lineHeight);

            normalTextColor = attributes.getColor(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_tabNormalColor, normalTextColor);
            selectTextColor = attributes.getColor(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_tabSelectColor, selectTextColor);

            int type = attributes.getInt(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_scaleType, 0);
            if (type == 0) {
            ...
            centerLayoutRule = attributes.getInt(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_centerLayoutRule, centerLayoutRule);
            hasPadding = attributes.getBoolean(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_hasPadding, hasPadding);

            centerAsFragment = attributes.getBoolean(com.next.easynavigation.R.styleable.EasyNavigationBar_Easy_centerAsFragment, centerAsFragment);
            attributes.recycle();
        }
    }
...
//        }
    ...
    private void setViewPagerAdapter() {
        if (mViewPager == null) {
            ...
            mViewPager.setId(com.next.easynavigation.R.id.vp_layout);
    ...
    private void addCenterTabView(int index) {
        ...
        if (centerLayoutRule == RULE_CENTER) {
            ...
            linearParams.addRule(RelativeLayout.ABOVE, com.next.easynavigation.R.id.empty_line);
    ...
    private void addTabItemView(final int position) {
        View itemView = View.inflate(getContext(), com.next.easynavigation.R.layout.navigation_tab_layout, null);

        LinearLayout ll_tab_content = itemView.findViewById(com.next.easynavigation.R.id.ll_tab_content);
        ...
        itemView.setTag(com.next.easynavigation.R.id.tag_view_position, position);
        ...
        View hintPoint = itemView.findViewById(com.next.easynavigation.R.id.red_point);
        ...
        //消息红点
        TextView msgPoint = itemView.findViewById(com.next.easynavigation.R.id.msg_point_tv);
        ...
        TextView text = itemView.findViewById(com.next.easynavigation.R.id.tab_text_tv);
        ImageView icon = itemView.findViewById(com.next.easynavigation.R.id.tab_icon_iv);
