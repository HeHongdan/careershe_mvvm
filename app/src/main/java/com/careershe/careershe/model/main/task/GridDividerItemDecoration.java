...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private int getMaxDividerWidth(View view) {
        ...
        int screenWidth = view.getContext().getResources().getDisplayMetrics().widthPixels > view.getContext().getResources().getDisplayMetrics().heightPixels
                ? view.getContext().getResources().getDisplayMetrics().heightPixels : view.getContext().getResources().getDisplayMetrics().widthPixels;
