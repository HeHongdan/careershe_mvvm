...
public class HttpsCompat {
    ...
    public static SSLSocketFactory getIgnoreSSLSocketFactory() {
        try {
            ...
            //参数：km身份验证密钥的来源或为null；tm对等身份验证信任决定的来源或者为null；random此生成器的随机性来源或为null
     ...
     * @return 套接字工厂。
     */
    private static SSLSocketFactory getEnableTls12SSLSocketFactory() {
        try {
